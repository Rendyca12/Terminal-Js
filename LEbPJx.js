...
/////    (Bantuan)
        case 'r12.help':
            output('<marquee behavior="scroll" direction="left" scrollamount="100" scrolldelay="2" width="100%"><font color="#96b38a" face="monospace" size="4px">____________________________________________________________________________</font> </marquee><h1 style="text-align: center; font-size: 15px; color: Red;">Using Dot (R12.) For Command!!!</h1><h1 style="text-align: center; font-size: 14px; color: Red;">Contoh: (R12.clear)</h1><p style="text-align: left; color: White;">Code: </br>🔴 R12.Status ➡ (Cek Status Anda)<br>🔴 R12.html ➡ (Pertinjau Html Buatan Anda)<br>🔴 R12.clock ➡ (Untuk Menampilkan Jam Di Layar)<br>🔴 R12.Status ➡ (Cek Status Anda)<br>🔴 R12.upload ➡ (Upload Html Anda, Agar Bisa Di Akses Semua Org)<br></p><marquee behavior="scroll" direction="Right" scrollamount="100" scrolldelay="2" width="100%"><font color="#96b38a" face="monospace" size="4px">____________________________________________________________________________</font> </marquee>');
          break;
///Page (Script Termux)
       case 'r12.418180':
